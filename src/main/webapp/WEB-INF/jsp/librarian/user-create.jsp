...
<head>
    ...
    <title>Create Member Account - Library Management System</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="content-wrapper">
            ...
            <div class="info-banner">
                <strong>Note:</strong> You are creating a regular member account. Member accounts have access to book browsing, borrowing, and personal library management features.
            </div>
            ...
            <form action="${pageContext.request.contextPath}/librarian/users/create" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" rows="3"
                              placeholder="Member address (optional)"><c:out value='${param.address}'/></textarea>
                </div>
