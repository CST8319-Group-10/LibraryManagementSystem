    ...
    <div class="container">
        ...
        <div class="dashboard-cards">
            ...
            <div class="card">
                ...
                <div class="features">
                    <a href="${pageContext.request.contextPath}/admin/users/create" class="feature-item">Add New Users</a>
            ...
            <div class="card">
                ...
                <div class="features">
                    <a href="${pageContext.request.contextPath}/admin/audit-logs" class="feature-item">Audit Logs</a>
                </div>
            </div>
        </div>

        <div style="margin-top: 30px; text-align: center; opacity: 0.8;">
            <p>Administrator Role | Full System Access | System Management</p>
        </div>
    </div>
</body>
</html>
