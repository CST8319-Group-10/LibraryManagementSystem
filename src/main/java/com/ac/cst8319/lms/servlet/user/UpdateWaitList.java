 ...
 */
@WebServlet(name = "UpdateWaitList", urlPatterns = "/user/returnBookUpdateWaitList")
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action != null) {
			if(action.equals("access")) {
				request.getRequestDispatcher("/WEB-INF/jsp/user/BookUpdateWaitList.jsp").forward(request, response);
			}
		}
	}
